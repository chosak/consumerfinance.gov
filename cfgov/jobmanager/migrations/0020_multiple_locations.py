...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='offices',
            field=models.ManyToManyField(related_name='job_listings', to='jobmanager.NewOffice', blank=True),
        ),
        migrations.AddField(
            model_name='joblistingpage',
            name='regions',
            field=models.ManyToManyField(related_name='job_listings', to='jobmanager.NewRegion', blank=True),
        ),
